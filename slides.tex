...
% --------------------------------------------------------------------------- %
  \begin{frame}{Distributed algorithms extremely hard}
      \textbf{Chord} is popular algorithm for P2P systems, paper published in
      2001 by strong team of MIT researchers, 10 years later bug found
      in specification \cite{stoica2001chord, Zave15}. Paper won best paper
      awart.

      \textbf{Snark} non-blocking deque algorithm, published by well known
...
% --------------------------------------------------------------------------- %
  \begin{frame}{Microsoft}
      model checking at Microsoft, cosmoss db, xbox
  \end{frame}
% --------------------------------------------------------------------------- %
  \begin{frame}{Opens source}
      elastic search, mongodb, hadoop/yarn/
  \end{frame}
% --------------------------------------------------------------------------- %
