      ...
      Basic logical operators:
        ...
        \centering
            \begin{tabular}{@{} llp{7cm} @{}}
                ...
                $\triangleq$& \mintinline{python}{=} &boolean operator, checks equality, it is not an assignment operator.
...
% --------------------------------------------------------------------------- %
  \begin{frame}{Multithreading Queue Spec Results}
    \begin{itemize}
      ...
      \item In number of threads > 2 * buffer capacity algorithm is not deadlock free.
    \end{itemize}
  \end{frame}
% --------------------------------------------------------------------------- %
