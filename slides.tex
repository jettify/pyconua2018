  ...
  \begin{frame}{TLA+ syntax. Sets}
      Basic set operations:
        ...
        \centering
            \begin{tabular}{@{} llp{7cm} @{}}
                Symb.       & Python & Description   \\ \hline
                $S \cup T$      & \mintinline{python}{s.union(t)} & Union\\
                $S \cap T$      & \mintinline{python}{s.intersection(t)} & Intersection \\
                $S \subseteq T$ & \mintinline{python}{s in t} & Membership  \\
                $S \setminus T$ & \mintinline{python}{s.difference(t)} & Difference \\
            \end{tabular}
        \end{table}
  \end{frame}
% --------------------------------------------------------------------------- %
